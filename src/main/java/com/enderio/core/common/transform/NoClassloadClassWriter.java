...
public class NoClassloadClassWriter extends ClassWriter {
    ...
    private static class ClassInfo extends ClassVisitor {
        ...
        @Override
        public void visit(int version, @SuppressWarnings("hiding") int access, @SuppressWarnings("hiding") String name,
                          String signature,
    ...
    protected String getCommonSuperClass(String type1, String type2) {
        if (type1.equals(OBJECT) || type2.equals(OBJECT)) { // Short circuit, don't bother loading Object from disk or
                                                            // cache
            return OBJECT;
        }
