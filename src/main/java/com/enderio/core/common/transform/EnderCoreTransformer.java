...
public class EnderCoreTransformer implements IClassTransformer {
    ...
    static final ObfSafeName renderItemOverlayIntoGUIMethod = new ObfSafeName("renderItemOverlayIntoGUI",
            "func_180453_a");
    static final ObfSafeName renderItemAndEffectIntoGUI = new ObfSafeName("renderItemAndEffectIntoGUI",
            "func_184391_a");
    static final ObfSafeName renderItemDisplayName = new ObfSafeName(
            "renderItemAndEffectIntoGUI, renderItemOverlayIntoGUI", "func_180453_a, func_184391_a");
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
                    ...
                    while (methods.hasNext()) {
                        ...
                        if (containerFurnaceMethod.equals(m.name)) {
                            ...
                            m.instructions.add(new MethodInsnNode(INVOKESTATIC,
                                    "com/enderio/core/common/transform/EnderCoreMethods", "transferStackInSlot",
                    ...
                    while (methods.hasNext()) {
                        ...
                        if (processInitialInteractMethod.equals(m.name)) {
                            ...
                            toAdd.add(new MethodInsnNode(INVOKESTATIC,
                                    "com/enderio/core/common/transform/EnderCoreMethods", "processInitialInteract",
                                    "(Lnet/minecraft/entity/player/EntityPlayer;Lnet/minecraft/util/EnumHand;)V",
                                    false));
        ...
        if (transformedName.equals(renderItemClass)) {
            return transform(basicClass, renderItemClass, renderItemDisplayName, new Transform() {
                ...
                void transform(Iterator<MethodNode> methods) {
                    ...
                    while (methods.hasNext()) {
                        MethodNode m = methods.next();
                        if (renderItemAndEffectIntoGUI.equals(m.name) &&
                                "(Lnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/item/ItemStack;II)V"
                                        .equals(m.desc)) {
                            InsnList toAdd = new InsnList();
                            toAdd.add(new VarInsnNode(ALOAD, 2));
                            ...
                            toAdd.add(new MethodInsnNode(INVOKESTATIC,
                                    "com/enderio/core/common/transform/EnderCoreMethods", "renderItemAndEffectIntoGUI",
                        ...
                        if (renderItemOverlayIntoGUIMethod.equals(m.name)) {
                            ...
                            toAdd.add(new VarInsnNode(ILOAD, 4));
                            toAdd.add(new MethodInsnNode(INVOKESTATIC,
                                    "com/enderio/core/common/transform/EnderCoreMethods", "renderItemOverlayIntoGUI",
                                    "(Lnet/minecraft/item/ItemStack;II)V", false));
                            ...
                            for (int i = 0; i < m.instructions.size(); i++) {
                                ...
                                if (!primed && target == null && next.getOpcode() == INVOKEVIRTUAL &&
                                        next instanceof MethodInsnNode) {
                                    if ("showDurabilityBar".equals(((MethodInsnNode) next).name)) { // Forge method,
                                                                                                    // never obf'ed
                                        primed = true;
                                    }
                                }
                                ...
                                if (target != null && next instanceof LabelNode &&
                                        ((LabelNode) next).getLabel() == target) {
                                    onframe = true;
                                    continue;
                                }
        ...
        if (transformedName.equals(entityPlayerClass)) {
            ...
            MethodVisitor mv = cw.visitMethod(Opcodes.ACC_PUBLIC, deObf ? "isElytraFlying" : "func_184613_cA", "()Z",
                    null, null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
            ...
            mv.visitMethodInsn(INVOKESPECIAL, "net/minecraft/entity/EntityLivingBase",
                    deObf ? "isElytraFlying" : "func_184613_cA", "()Z", false);
            Label l1 = new Label();
            mv.visitJumpInsn(IFNE, l1);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitMethodInsn(INVOKESTATIC, "com/enderio/core/common/transform/EnderCoreMethods", "isElytraFlying",
            ...
            mainLogger
                    .info("Transforming " + entityPlayerClass + " finished, added " +
                            (deObf ? "isElytraFlying()" : "func_184613_cA()") + " overriding EntityLivingBase");
                ...
                void transform(Iterator<MethodNode> methods) {
                    ...
                    while (methods.hasNext()) {
                        ...
                        if (updateTaskMethod.equals(m.name)) {
                            ...
                            list.add(new FieldInsnNode(GETFIELD, "net/minecraft/entity/ai/EntityAICreeperSwell",
                                    deObf ? "swellingCreeper" : "field_75269_a",
                                    "Lnet/minecraft/entity/monster/EntityCreeper;"));
                            list.add(new VarInsnNode(ALOAD, 0));
                            list.add(new FieldInsnNode(GETFIELD, "net/minecraft/entity/ai/EntityAICreeperSwell",
                                    deObf ? "creeperAttackTarget" : "field_75268_b",
                                    "Lnet/minecraft/entity/EntityLivingBase;"));
                            list.add(new MethodInsnNode(INVOKESTATIC,
                                    "com/enderio/core/common/transform/EnderCoreMethods", "isCreeperTarget",
                                    "(Lnet/minecraft/entity/monster/EntityCreeper;Lnet/minecraft/entity/EntityLivingBase;)Z",
                                    false));
                            ...
                            list.add(
                                    new MethodInsnNode(INVOKEVIRTUAL, "net/minecraft/entity/monster/EntityCreeper",
                                            deObf ? "setCreeperState" : "func_70829_a", "(I)V", false));
                            list.add(new InsnNode(Opcodes.RETURN));
                            list.add(ldone);
                            list.add(new FrameNode(Opcodes.F_FULL, 1,
                                    new Object[] { "net/minecraft/entity/ai/EntityAICreeperSwell" }, 0,
                                    new Object[] {}));
