...
public enum CompatRegistry {
    ...
    private static class Registration {
        ...
        public java.lang.String toString() {
            return "CompatRegistry.Registration(modids=" + java.util.Arrays.deepToString(this.getModids()) +
                    ", times=" + java.util.Arrays.deepToString(this.getTimes()) + ")";
        }
    }
    ...
    private static void doLoad(String clazz) {
        try {
            ...
            EnderCore.logger.error("[Compat] ICompatability class {} did not contain static method {}!", clazz,
                    ICompat.METHOD_NAME);
            e.printStackTrace();
