...
public class FluidWrapper {
    ...
    public static int transfer(IBlockAccess world, BlockPos frompos, EnumFacing fromside, BlockPos topos,
                               EnumFacing toside, int limit) {
        return transfer(wrap(world, frompos, fromside), wrap(world, topos, toside), limit);
    }

    public static int transfer(IBlockAccess world, BlockPos frompos, EnumFacing fromside, TileEntity to,
                               EnumFacing toside, int limit) {
    ...
    public static int transfer(TileEntity from, EnumFacing fromside, IBlockAccess world, BlockPos topos,
                               EnumFacing toside, int limit) {
