 ...
 *            use one of the TypeToken constructors.
 */
public class JsonConfigReader<T> implements Iterable<T> {
     ...
     *                     file from your jar if it does not exist in the
     *                     config folder
     * @param fullFileName
     ...
     *                     same type as the generic type of this class.
     */
     ...
     *                from your jar if it does not exist in the
     *                config folder
     * @param file
     *                The {@link File} representing your JSON config.
     * @param objType
     ...
     * the elements contained in its array.
     * <p>
