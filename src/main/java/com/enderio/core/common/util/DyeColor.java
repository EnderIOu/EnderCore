...
public enum DyeColor implements ICycleEnum {
    ...
    public static final String[] DYE_ORE_UNLOCAL_NAMES = {
            ...
            "item.fireworksCharge.brown", "item.fireworksCharge.blue",
            "item.fireworksCharge.purple", "item.fireworksCharge.cyan", "item.fireworksCharge.silver",
            "item.fireworksCharge.gray", "item.fireworksCharge.pink",
            "item.fireworksCharge.lime", "item.fireworksCharge.yellow", "item.fireworksCharge.lightBlue",
    ...
    public static final IWidgetIcon[] DYE_ICONS = {
            ...
            EnderWidget.COLOR_BLACK, EnderWidget.COLOR_RED, EnderWidget.COLOR_GREEN, EnderWidget.COLOR_BROWN,
            EnderWidget.COLOR_BLUE, EnderWidget.COLOR_PURPLE,
            EnderWidget.COLOR_CYAN, EnderWidget.COLOR_SILVER, EnderWidget.COLOR_GRAY, EnderWidget.COLOR_PINK,
            EnderWidget.COLOR_LIME, EnderWidget.COLOR_YELLOW,
