    ...
    public void onPlayerJoin(PlayerLoggedInEvent event) {
        if (ConfigHandler.invisibleMode == 1 && ConfigHandler.instance().showInvisibleWarning()) {
            ...
            String reason = String.format(
                    EnderCore.lang.localize(reasonBase + (EnderCore.instance.invisibilityRequested() ? "1" : "2"),
                            EnderCore.instance.getInvisibleRequsters()));
            String text1 = String.format(EnderCore.lang.localize(warnBase + "1"), TextFormatting.RED,
                    TextFormatting.WHITE, reason);
            String text2 = String.format(EnderCore.lang.localize(warnBase + "2"), TextFormatting.BOLD,
