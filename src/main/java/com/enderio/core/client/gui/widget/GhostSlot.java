...
public abstract class GhostSlot {
    ...
    public static interface IGhostSlotAware {
         ...
         * ghost slot before storing the given stack.
         *
         * @param slot
    ...
    /**
     * Draw a normal item tooltip for the stack returned by {@link #getStack()}? Override
     * {@link #drawGhostSlotToolTip(GuiContainerBase, int, int)} to draw
