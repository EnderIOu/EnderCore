...
public class SpecialTooltipHandler {
    ...
    public static void addTooltip(ItemTooltipEvent evt) {
        ...
        if (evt.getItemStack().getItem() instanceof IAdvancedTooltipProvider) {
            ...
            if (blk instanceof IAdvancedTooltipProvider) {
                addInformation((IAdvancedTooltipProvider) blk, evt.getItemStack(), evt.getEntityPlayer(),
                        getTooltip(evt), flag);
    ...
    public static void addDurabilityTooltip(@NotNull List<String> toolTip, @NotNull ItemStack itemStack) {
        ...
        if (item instanceof ItemTool || item instanceof ItemArmor || item instanceof ItemSword ||
                item instanceof ItemHoe || item instanceof ItemBow || item instanceof ItemShears) {
